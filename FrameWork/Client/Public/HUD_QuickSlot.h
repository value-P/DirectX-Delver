...
class HUD_QuickSlot : public UI
{
protected:
	explicit HUD_QuickSlot(LPDIRECT3DDEVICE9 _pGraphicDevice);
	virtual ~HUD_QuickSlot();

public:
	static HUD_QuickSlot* Create(LPDIRECT3DDEVICE9 _pGraphicDevice, const _float& _fX, const _float& _fY, const _float& _fSizeX, const _float& _fSizeY);
